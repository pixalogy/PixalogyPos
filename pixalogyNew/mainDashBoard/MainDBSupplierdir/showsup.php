...
$result = $conn->query("SELECT `id`, `supID`, `supname`, `supDA`, `supPnum`, `supBranch`, `comID`, `companyName`, `DistributeAddress`, `Tel`, `proAID`, `productName`, `itemName`, `sizeAvailable`, `smallav`, `priceavs`, `mediumav`, `priceavm`, `largeav`, `priceavl`, `unitAvailable`, `smallusa`, `smallus`, `smallup`, `mediumuma`, `medianus`, `medianup`, `largeusa`, `largeus`, `largeup`, `otherprice` FROM `supdir` ");
